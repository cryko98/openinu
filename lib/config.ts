export const SITE = {
  ...
  description:
    "OpenINU ($OPENINU) — the Shiba Inu powered AI on Solana. Paired to OpenAI stock on stonkfun.xyz.",
...
export const SUGGESTIONS = [
  ...
  {
    title: "Write me a bark-worthy meme",
    subtitle: "shiba flavoured alpha",
    prompt: "Write a short, funny meme caption about $OPENINU vs OpenAI.",
  },
];
